 ...
 *
 * @category Class
 * @description Discriminated union of source leaves (all 4, including &#x60;upload&#x60;) consumed by V2 single-input &#x60;JobDefinition.source&#x60;. Multi-input &#x60;JobInputV2.source&#x60; consumes the narrower &#x60;MultiInputSource&#x60; (this union minus the &#x60;upload&#x60; leaf) — see that schema and &#x60;JobInputV2&#x60;. Per [ADR-0005](../docs/decisions/0005-external-sources.md) + [ADR-0004](../docs/decisions/0004-job-shape.md).  Wiring into &#x60;JobDefinition&#x60; lands via ticket [I12 (&#x60;Gr0VKFya&#x60;)](https://trello.com/c/Gr0VKFya).  **All four leaves are CLOSED** (&#x60;additionalProperties: false&#x60;) to exactly the API&#39;s per-leaf allowlist (&#x60;WorkflowSourceV2Constraint&#x60;, which hard-rejects any extra key). This is a deliberate forward-compat stance (ticket [&#x60;fZXM5VZd&#x60;](https://trello.com/c/fZXM5VZd)): a client sending a *future* additive field fails contract-validation the same way the API already rejects it — so contract and runtime agree. Adding a new field to a leaf therefore requires a paired API-allowlist change in the same co-land. The union aliases themselves (&#x60;WorkflowSource&#x60;, &#x60;MultiInputSource&#x60;, &#x60;ExternalSource&#x60;) stay open — they are &#x60;oneOf&#x60; dispatchers, not property-bearing objects.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech

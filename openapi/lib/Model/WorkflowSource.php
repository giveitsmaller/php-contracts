...
class WorkflowSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'type' => false,
        'file_id' => false,
        'declared_duration_seconds' => false,
        'from' => false,
        'operation' => false,
    ...
    public function setDeclaredDurationSeconds($declared_duration_seconds)
    {
        if (is_null($declared_duration_seconds)) {
            throw new \InvalidArgumentException('non-nullable declared_duration_seconds cannot be null');
        }

        if (($declared_duration_seconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $declared_duration_seconds when calling WorkflowSource., must be bigger than or equal to 0.');
        }

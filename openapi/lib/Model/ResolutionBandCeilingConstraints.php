<?php
/**
 * ResolutionBandCeilingConstraints
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResolutionBandCeilingConstraints Class Doc Comment
 *
 * @category Class
 ...
 */
class ResolutionBandCeilingConstraints implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResolutionBandCeiling_constraints';
     ...
     *
     * @param string|null $max_input_duration ISO-8601 duration; the band's input duration ceiling.
     *
     * @return self
     */

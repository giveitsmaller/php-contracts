<?php
/**
 * CreateBillingCheckoutSession422Response
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateBillingCheckoutSession422Response Class Doc Comment
 *
 * @category Class
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateBillingCheckoutSession422Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createBillingCheckoutSession_422_response';
    ...
    public function setViolations($violations)
    {
        ...
        if ((count($violations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $violations when calling CreateBillingCheckoutSession422Response., number of items must be greater than or equal to 1.');
        }

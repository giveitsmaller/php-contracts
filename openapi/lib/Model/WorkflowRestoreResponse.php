...
/**
 * WorkflowRestoreResponse Class Doc Comment
 *
 * @category Class
 * @description Response body for &#x60;POST /api/workflows/{id}/restore&#x60; (ticket [&#x60;j2s6T2qf&#x60;](https://trello.com/c/j2s6T2qf)). Restoring clears the &#x60;archived&#x60; flag so the workflow reappears in the default list. The inverse of archive — status, jobs, outputs, and downloads are untouched.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WorkflowRestoreResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WorkflowRestoreResponse';
    ...
    public function setWorkflowId($workflow_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($workflow_id)))) {
            throw new \InvalidArgumentException("invalid value for \$workflow_id when calling WorkflowRestoreResponse., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
     ...
     * Sets archived
     *
     * @param bool $archived Always `false` on a 200 — the workflow is no longer archived (or was never archived; restore is an idempotent no-op there). No `archived_at` is returned once restored.
     *
     * @return self
     */

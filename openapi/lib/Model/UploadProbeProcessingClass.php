 ...
 *
 * @category Class
 * @description Tier-aware pre-assignment. Same logic as F8.1 upload-side gating (per ticket I15-CONS) — reflects what the server would route this file to under the caller&#39;s current tier. &#x60;blocked&#x60; is emitted when no tier-permitted pool exists for the file — any caller probing a &#x60;corrupt&#x60; / &#x60;unsupported_codec&#x60; file, or a caller below a class&#39;s &#x60;required_tier&#x60;. Since 2026-09-23 (decision 26) no class carries one, so the tier branch is currently unreachable.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */

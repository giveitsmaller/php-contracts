...
class SseOperationCompletedData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \Gisl\Generated\OpenApi\Model\OperationResultMetadata|null $result_metadata OPTIONAL. The same whitelisted per-operation metadata the REST operation object serves as `result_metadata` (a sibling of `result` there too): `already_optimal`, `estimated_saving_pct`, `watermark_id`. It lets the completion frame say \"already optimal\" without a follow-up read. Absent means the frame does not carry it, NOT that the operation has no metadata; a consumer that needs it falls back to the REST read. Card `Fu372Ze7` (api), contracts `DIDOPiZQ`.
     *
     * @return self
     */

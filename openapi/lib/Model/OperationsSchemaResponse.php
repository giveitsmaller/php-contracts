...
class OperationsSchemaResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'environment' => 'string',
        'tier_defaults' => '\Gisl\Generated\OpenApi\Model\TierDefaults',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tier_defaults', $data ?? [], null);
     ...
     * Gets tier_defaults
     *
     * @return \Gisl\Generated\OpenApi\Model\TierDefaults|null
     */
    public function getTierDefaults()
    {
        return $this->container['tier_defaults'];
    }

    /**
     * Sets tier_defaults
     *
     * @param \Gisl\Generated\OpenApi\Model\TierDefaults|null $tier_defaults tier_defaults
     *
     * @return self
     */
    public function setTierDefaults($tier_defaults)
    {
        if (is_null($tier_defaults)) {
            throw new \InvalidArgumentException('non-nullable tier_defaults cannot be null');
        }
        $this->container['tier_defaults'] = $tier_defaults;

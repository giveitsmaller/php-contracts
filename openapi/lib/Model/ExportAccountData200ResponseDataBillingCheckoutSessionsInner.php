<?php
/**
 * ExportAccountData200ResponseDataBillingCheckoutSessionsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ExportAccountData200ResponseDataBillingCheckoutSessionsInner Class Doc Comment
 *
 * @category Class
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class ExportAccountData200ResponseDataBillingCheckoutSessionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'exportAccountData_200_response_data_billing_checkout_sessions_inner';
     ...
     * Sets mode
     *
     * @param string $mode The checkout mode (`payment` for a credit pack, `subscription`).
     *
     * @return self
     */
     ...
     * Sets fulfilled_at
     *
     * @param \DateTime|null $fulfilled_at When the purchase was applied; `null` while it has not been.
     *
     * @return self
     */

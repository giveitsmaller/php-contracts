...
class WorkflowPausedDetailLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets resume
     *
     * @param string|null $resume URL of the frontend page for this workflow (e.g. `{frontend}/{locale}/profile/workflows/{id}`), where the user can resume it. **NOT the API call:** a client resumes with the `resumeWorkflow` operation (`POST /api/workflows/{id}/resume`).
     *
     * @return self
     */

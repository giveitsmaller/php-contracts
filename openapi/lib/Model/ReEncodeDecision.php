 ...
 *
 * @category Class
 * @description Path the worker actually took for a SUCCESSFUL &#x60;merge.video&#x60;, reported in EVERY &#x60;re_encode_mode&#x60;: &#x60;always&#x60; reports &#x60;re_encode&#x60;; &#x60;never&#x60; reports &#x60;stream_copy&#x60;; &#x60;auto&#x60; reports whichever path it chose. Absent for non-&#x60;merge.video&#x60; operations and on any failed operation, even one that carries other metrics such as sizes or cost figures (for example a &#x60;never&#x60; request whose inputs need a re-encode, or a long-form merge the uniformity gate refuses before the path is decided). Per ticket I16-CONS (Trello 7nCZXEru).  ⚠️ An earlier revision said the field was ABSENT under &#x60;always&#x60; / &#x60;never&#x60;. The worker never behaved that way (it reports the path in every mode), and the same contract listed an &#x60;always&#x60;-mode reason as an example, so the text contradicted itself. The worker&#39;s behaviour is the canonical one (ruled 2026-09-24 on compression_e2e&#39;s report); a consumer MUST NOT assert absence on a successful merge under a caller-fixed mode.  Mirrors the AsyncAPI &#x60;ReEncodeDecision&#x60; (and &#x60;OperationMetrics.re_encode_decision&#x60;); exposed on the REST &#x60;OperationResult.metrics&#x60; per ticket zS4e9CI2 so the SDK customer path carries the same signal as the SSE/message surface. Cross-spec enum parity is verified by &#x60;tests/test_asyncapi_named_schemas.py&#x60;.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */

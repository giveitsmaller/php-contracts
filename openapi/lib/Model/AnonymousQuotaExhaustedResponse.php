 ...
 */
class AnonymousQuotaExhaustedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AnonymousQuotaExhaustedResponse';

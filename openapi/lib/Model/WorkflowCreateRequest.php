 ...
 *
 * @category Class
 * @description Create a workflow. **Two mutually-exclusive request forms:**  - **Explicit jobs** — &#x60;jobs[]&#x60; (+ optional &#x60;workflow_edges&#x60;), the   full multi-job DAG form. Use for multi-job workflows, role-based   / multi-input operations, output-as-role-input chains, explicit   edges, or &#x60;delivery.selection.type: explicit&#x60;. - **Flat (single-job sugar)** — top-level &#x60;source&#x60; + &#x60;operations[]&#x60;,   **exactly equivalent to &#x60;jobs: [{ source, operations }]&#x60;** (per   ticket [&#x60;D0Gsri8V&#x60;](https://trello.com/c/D0Gsri8V)). The server   lowers it into one &#x60;JobDefinition&#x60; and validates it as such —   inheriting every &#x60;JobDefinition&#x60; guard verbatim — then runs the   existing single-job canonicalizer. For the file-first   dump-and-go case: one input + a set of single-input operations   (a chain plus &#x60;base&#x60;-derived branches like thumbnail / split).  The two forms are mutually exclusive (a request supplies exactly one — enforced by the &#x60;oneOf&#x60; below); they are NOT combined.  🔴 **THE FLAT FORM IS &#x60;planned&#x60;, AND THE SERVER DOES NOT ACCEPT IT YET.** Send &#x60;jobs[]&#x60;. A flat request is rejected today, and the rejection is currently a generic *\&quot;At least one job is required\&quot;* rather than the &#x60;feature_not_available&#x60; (422) envelope this contract requires for a &#x60;planned&#x60; shape — tracked against &#x60;compression_api&#x60;, so do not read that generic message as a validation error in your own payload.  ⚠️ **The equivalence stated above is the DESIGN, not observed behaviour.** It describes what the server will do once the lowering ships. It carried no availability marker from v2.64.0 until 2026-09-10, which per ADR-0001 §1.4 meant it read as &#x60;stable&#x60; — a GA claim about a shape nothing accepts. Neither shipped SDK ever emitted it: the TypeScript and PHP builders both always send &#x60;jobs[]&#x60;, so the exposure was a hand-built payload and this document&#39;s own claim.  Because the flat form lowers to ONE single-input job, its &#x60;operations[]&#x60; admits only **single-input** operation types. The multi-input / role operations (&#x60;merge&#x60;, &#x60;archive&#x60;, &#x60;image_watermark&#x60;, &#x60;custom_luma&#x60;, &#x60;audio_overlay&#x60;, &#x60;audio_to_video&#x60;, &#x60;video_watermark&#x60; — the enum at the &#x60;JobDefinition&#x60; multi-input guard) require &#x60;inputs[]&#x60; and MUST use the explicit &#x60;jobs[]&#x60; form; the server rejects them in flat mode via that same &#x60;JobDefinition&#x60; guard after lowering (not a separate structural rule). The flat form also does **not** support &#x60;workflow_edges&#x60; or &#x60;delivery.selection.type: explicit&#x60; — both need a named job id the single implicit job has none of; use explicit &#x60;jobs[]&#x60; for those. Delivery defaults and selection otherwise behave exactly as for one explicit job.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class WorkflowCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'notify' => '\Gisl\Generated\OpenApi\Model\NotifyConfig'
    ];
     ...
     * Gets notify
     *
     * @return \Gisl\Generated\OpenApi\Model\NotifyConfig|null
     */
     ...
     * Sets notify
     *
     * @param \Gisl\Generated\OpenApi\Model\NotifyConfig|null $notify Optional per-job completion-notification config (channel-agnostic). Currently exposes the `email` channel: the API emails the configured recipients when the selected workflow events occur, with a **server-composed** presigned `/downloads` link to the results — the request carries recipients + event selection only.  **Advertised-ahead (contract-first, ticket [`IQtEwVET`](https://trello.com/c/IQtEwVET)):** the completion- notification dispatch engine is built separately; until it ships the API returns `feature_not_available` (422) for any `notify` use. Reuses the `CallbackEventType` vocabulary shared with `callback_events` (webhook) — email and webhook are two channels off one dispatch engine.
     *
     * @return self
     */
